       ...
       <div>
          {
...

              {
                  Data.length === 3 && 
                  <div className="w-full flex max-h-[600px] overflow-hidden">
                       <Link className="w-[60%] mr-[1px]" to={`/post/detail/${Data[0]._id}`} ><img className="w-full h-full object-cover mr-[2px]" src={Data[0].image} alt="anh"/></Link>
...

              {
                  ...
                  <div className="w-full h-full flex overflow-hidden">
                       <Link className="mr-[1px] w-[60%]" to={`/post/detail/${Data[0]._id}`} ><img className="w-full h-full object-cover mr-[2px]" src={Data[0].image} alt="anh"/></Link>
                       <div className="w-[40%] h-full flex flex-col">
                          <Link className="w-full m-h-[33.33333px]" to={`/post/detail/${Data[1]._id}`} ><img className="w-full h-full object-cover " src={Data[1].image} alt="anh"/>  </Link>
                          <Link className="w-full m-h-[33.33333px]" to={`/post/detail/${Data[2]._id}`} ><img className="w-full h-full object-cover mt-[2px]" src={Data[2].image} alt="anh"/></Link>
                          <Link className="w-full m-h-[33.33333px]" to={`/post/detail/${Data[3]._id}`} ><img className="w-full h-full object-cover mt-[2px]" src={Data[3].image} alt="anh"/></Link>
                       </div>
                  </div>
              }

              {
                  Data.length > 4 && 
                  <div className="w-full flex max-h-[600px] overflow-hidden">
                       <Link className="w-[60%] min-h-[100%] block mr-[1px]" to={`/post/detail/${Data[0]._id}`} ><img className="w-full h-full object-cover " src={Data[0].image} alt="anh"/></Link>
